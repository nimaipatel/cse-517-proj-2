...
uint64_t
mem_read(const void *addr, size_t len)
{
    uint64_t rdata;
...
void
mem_write(void *addr, uint64_t val, size_t len)
{
...
/* Emulation of memcpy */
void *
mem_memcpy(void *dst, const void *src, size_t n)
{
    void *savedst = dst;
...
/* Emulation of memset */
void *
mem_memset(void *dst, int c, size_t n)
{
    void *savedst = dst;
...
void
hprobe(void *ptr, int offset, size_t count)
{
